...
### ✅ `g4a1-1-2`#٤ — شعارُ سلطنةِ عُمان (٢٠٢٦-٠٨-٢٩)

`images/شعار-عمان.png` (‏٨٩٤×٩٠٠ · نسبة ٠٫٩٩ · ٩٢KB · شفّافُ الخلفية)، مربوطاً بحقلِ
`svg` عبرَ `<image>` داخلَ `viewBox`، مع **`fit:"width"`** لأنّ المربَّعَ كانَ يُعرَضُ
بـ‏٤٩٫٦٪ من عرضِ الملعبِ فقط — وبعدَه ‏**٨٥٫٣٪ × ٨٠٫١٪**.

**والأجزاءُ من المالكِ لا من التوليد.** حاولَ جيميناي أربعَ مرّاتٍ فأخرجَ في كلِّ مرّةٍ
خنجراً يمنياً منحنيَ النصلِ لا **الخنجرَ العُمانيَّ** ذا الغِمدِ القائمِ المزخرَف — وهو
شعارُ دولةٍ لا يُقارَبُ بالتقريب. فأرسلَ المالكُ **أجزاءَه مصوَّرةً منفصلة**، فاستُخرِجَ
منها الخنجرُ والسيفانِ من الملفِّ الأول والنِّطاقُ من الثاني (كانَ أنظف).

**والمعالجةُ ثلاثُ خطواتٍ مقيسة:** تشفيفُ المحيطِ بجعلِ سطوعِ الخطِّ شفافيةً · ملءُ
الداخلِ أبيضَ مصمتاً بفيضٍ من إطارٍ مبطَّن · **إصلاحُ اقتطاعِ النِّطاقِ من جهةٍ واحدة**
(نبّهَ إليه المالك) — قِيسَ ميلُ الكثافةِ فبانَ الجناحُ الأيسرُ ‏١٠٠px والأيمنُ ‏٨٠px،
فأُعيدَ بناءُ النِّطاقِ بمرآةِ نصفِه السليمِ حولَ مركزِ العقدةِ (‏x=190) — والفرقُ بينَ
الطرفَينِ الآنَ **صفر**.

**والترتيبُ من تحتُ إلى فوق:** السيفانِ ثمّ النِّطاقُ ثمّ الخنجر — كما في الشعارِ الرسميّ.

**ونقاطُ السحبِ الثلاثُ قِيسَت بالعزلِ الطرحيّ** (تركيبٌ بلا كلِّ جزءٍ ثمّ فرقٌ عن
التركيبِ الكامل)، فكلُّ نقطةٍ **يملكُها جزؤُها وحدَه بلا تداخل**:

| البطاقة | `dot` | الحبر | الخنجر | السيفان | النِّطاق |
|---|---|:--:|:--:|:--:|:--:|
| الخِنْجَرُ | ‏(٥٠، ٨٠) | ٩٠ | **٩٠** | ٠ | ٠ |
| السَّيْفانِ | ‏(١٢، ١٠) | ٨٨ | ٠ | **٨٨** | ٠ |
| النِّطاقُ | ‏(٢٢، ٤٧) | ٩٠ | ٠ | ٠ | **٩٠** |

> ⚠️ **ونُقِضَ ذلك في الجلسةِ نفسِها بمرجعٍ أرسلَه المالك (٢٠٢٦-٠٨-٢٩):** رأى التركيبَ
> منشوراً فطلبَ **توزيعَ الأجزاءِ كما في صورةِ الشعارِ الرسميّ**، فأُعيدَ البناءُ بنسبٍ
> **مقيسةٍ من المرجعِ نفسِه** لا مقدَّرةٍ بالعين — تُنسَخُ بها الفقرةُ أعلاه.

#### النسخةُ المعتمدة — نسبٌ مقيسةٌ من صورةِ المرجع

مُسِحَ حبرُ المرجعِ (أحمرُ الخطِّ: ‏`R−G>40` و`R−B>40`) فخرجَ صندوقُه ‏٨٨٩×٨٧٨، ثمّ
قِيسَت فيه ثلاثةُ معالمَ تُثبِّتُ الأجزاءَ الثلاثة:

| المَعْلَم | المرجع | المبنيّ |
|---|---|---|
| شريطُ النِّطاقِ — ارتفاعاً | ‏٤٢٫١٤٪ .. ٥٣٫٣٠٪ | ‏٤٢٫٠٦٪ .. ٥٣٫١٧٪ |
| شريطُ النِّطاقِ — عرضاً | ‏١٥٫٩٧٪ .. ٨٢٫١١٪ | ‏١٦٫٣٨٪ .. ٨١٫٥٧٪ |
| قمّةُ الخنجر | ‏٤٫٧٨٪ | ‏٤٫٨٨٪ |
| طرفُ غمدِ الخنجر | ‏(٢٤٫٧٥٪، ٥٩٫٤٥٪) | ‏(٢٥٫٨٢٪، ٥٨٫٩٦٪) |

**والسيفانِ يملآنِ الصندوقَ** — فهما أطرافُه الأربعةُ في المرجعِ (قمّتاهما ٠٪ وطرفاهما ١٠٠٪)،
ولذلك صارَ صندوقُ الشعارِ **هو صندوقَهما**.

> **وما كانَ الخطأُ في التركيبِ الأول؟ النِّسَبُ بينَ الأجزاءِ لا مواضعُها:** كانَ الخنجرُ
> ‏٨٨٪ من الارتفاعِ وحقُّه ‏**٦٣٪**، والنِّطاقُ ‏٥٦٪ من العرضِ وحقُّه ‏**٦٦٪**، والسيفانِ
> ‏٨٨٪ وحقُّهما ‏**١٠٠٪**. فبدا الخنجرُ عملاقاً والسيفانِ قزمَين.

**ونقاطُ السحبِ أُعيدَ قياسُها على البناءِ الجديد** بالعزلِ الطرحيِّ نفسِه، وكلُّها مملوكةٌ
لجزئِها وحدَه: الخنجرُ ‏(٥٠، ٢٢) ‏٢٥٣ بكسلاً · السيفانِ ‏(١٢، ٨) ‏٢٤٥ · النِّطاقُ ‏(٢٠، ٤٧) ‏٢٥١
— وصفرٌ لغيرِ صاحبِها في الثلاث. *(بالإحداثيّاتِ على الرسمِ نفسِه؛ وفي البياناتِ تُكتَبُ
منسوبةً إلى صندوقِ العرضِ المبطَّنِ أدناه.)*

#### وهامشٌ شفّافٌ يُصغّرُه ويرفعُه عن مربّعاتِ الإفلات

طلبَ المالكُ ثانياً **تصغيرَه لتنزلَ مربّعاتُ الإفلاتِ أسفلَه لا فوقَه**. والمربّعاتُ عندَ
‏**٨٠٪** من الملعبِ ثابتةً، والشعارُ كانَ ينتهي عندَ **٩٥٪** فيتراكبانِ.

**ولا مقبضَ لحجمِ الرسمِ في البيانات:** ‏`fit:"width"` يجعلُ عرضَ الصندوقِ ‏٨٦٪ من الملعبِ
مهما كانَ محتواه، و`.labelimg` بلا الوسمِ يهبطُ إلى ‏٤٩٪ فينتهي عندَ ‏٧٥٫١٪ — **بفارقٍ
خمسةِ أعشارِ نقطةٍ عن المربّعات**، وهو التصاقٌ لا فَصْل.

**فالمقبضُ صندوقُ العرضِ نفسُه:** ‏`viewBox` صارَ ‏١٢٥٢×١٠٩٥ والرسمُ ‏٨٨٢×٨٨٩ داخلَه عندَ
‏`x=185, y=0` — هامشٌ جانبيٌّ **يُصغّرُه** وسفليٌّ **يرفعُه**. مقيسٌ على أربعةِ منافذَ
(‏٤٣٠ · ٨٢٠ · ١٢٨٠ · ١٩٢٠ عرضاً): الحبرُ ‏**٥٩٪ عرضاً** وينتهي عندَ ‏**٧٣٫٤–٧٣٫٩٪**،
فالفجوةُ عن المربّعاتِ ‏**نحوُ سبعِ نقاطٍ** في كلِّها.

> ⚠️ **وقياسُ الحبرِ يستثني البرتقاليَّ وجوباً:** النقاطُ ‏`.dnd-dot` والخيوطُ ‏`.dndline`
> برتقاليةٌ تمتدُّ إلى المربّعاتِ نفسِها، فمرشّحُ «أحمر» وحدَه يبتلعُها ويُعطي قاعاً كاذباً
> عندَ ‏٧٩٫٦٪ بدلَ ‏٧٣٫٢٪. الفارقُ ‏`|G−B|<25` — أحمرُ الشعارِ متوازنٌ والبرتقاليُّ ليس.

> ⚠️ **و`dot` نسبةٌ من صندوقِ العرضِ لا من الرسم**، فالهامشُ يوجبُ تحويلَها:
> ‏`x=(185+882·xرسم/100)/1252` و`y=(889·yرسم/100)/1095`. مثبَّتٌ في تعليقِ الثابتِ
> ‏`SHOOGP_SVG_EMBLEM` في `js/questions.js`.


#### وصفّانِ للإفلاتِ لا صفّ — لأنّ الوسمَ لا يُصغَّر (٢٠٢٦-٠٨-٢٩)

رأى المالكُ السؤالَ مُجاباً فبانَ عيبٌ لا يظهرُ قبلَ الإفلات: **الأوسمةُ الثلاثةُ
تتراكب**. وطلبَ «تصغيرَ الكلمات».

**والكلماتُ لا تُصغَّر — والمانعُ قاعدةُ نظامٍ منصوصة:**
```
.shoogp-ui .qwin .target{ min-height:60px; font-size:max(18px, 1rem) !important; }
```
حدُّ اللمسِ ‏٦٠px وحدُّ المقروئيةِ ‏١٨px (‏§٨ في `shoogp-ui.css`، ونصُّها: «الحدودُ ليست
كسوةً بل قاعدةَ لمسٍ ومقروئية»). **والخطُّ اليومَ عندَ الحدِّ ‏١٨px بالضبط**، فتصغيرُه
خرقٌ لا إصلاح.

**والحسابُ يُثبِتُ أنّ الصفَّ الواحدَ مستحيلٌ لا ضيّقٌ فحسب:** الملعبُ ‏٤١٤px تصميماً،
وأعرضُ وسمٍ ‏١٨٣px منها **٦٠px كسوةُ كبسولةٍ ثابتة** (‏`padding:14px 26px`) و‏١٢٧px نصٌّ
عندَ الحدِّ الأدنى. فلو أُلغيَتِ الحشوةُ كلُّها لبقيَ ‏١٣١px والممرُّ ‏١٣٢px — أي أنّ
الثلاثةَ لا تسعُ صفّاً واحداً **ولو بلا حشوةٍ إطلاقاً**.

> ⚠️ **وجُرِّبَ أولاً حارسٌ عامٌّ في `js/app.js` يُصغّرُ الخطَّ والحشوةَ حتى يسعَ الممرَّ،
> ثمّ أُلغيَ ورُدَّ الملفُّ كما كان** — لأنّه يخرقُ حدَّ الـ١٨px بالضبط. **فالعلاجُ في
> البياناتِ لا في الطبقةِ المشتركة.**

**فصارَ الإفلاتُ صفَّين:** «السَّيْفانِ» و«النِّطاقُ» عندَ ‏٧١٫٦٪ ارتفاعاً (‏٢٦٪ و‏٧٤٪
عرضاً)، و«الخِنْجَرُ» وحدَه عندَ ‏٩٠٪. ورُفِعَ الشعارُ وصُغِّرَ إلى ‏٥٢٪ عرضاً (‏`viewBox`
صارَ ‏١٤٣١×١٤٥٦) فينتهي حبرُه عندَ ‏٦١٫٦٪ — والفجوةُ إلى الصفِّ الأولِ ‏٦px، وبينَ
الصفَّينِ ‏٩px، وتحتَ الثاني ‏١٠px.

**وبطاقةُ النِّطاقِ نُقِلَ هدفُها إلى جناحِه الأيمن** (‏`dot` من ‏٢٠٪ إلى ‏٧٨٪ من الرسم)
لأنّ صندوقَها صارَ يميناً — فالخيطُ رأسيٌّ قصيرٌ بدلَ قُطرٍ يعبرُ الشعارَ كلَّه.
والنِّطاقُ متماثلٌ فالجناحانِ سواءٌ في الدلالة.
...
> ✅ **أُنجِزَ ٢٠٢٦-٠٩-٠٢ عبرَ مسارِ n8n** (دفعتا `2026-09-02-sneeze-etiquette` ثمّ
> `2026-09-02-sneeze-palm-v2` — الكفُّ أُعيدَت لأنّ المخرَجَ الأوّلَ وضعَها على الجبهة).
> الصورُ الثلاثُ في `images/` مفرَّغةَ الخلفيةِ (‏١١–١٥ KB)، والسؤالُ مركَّبٌ بـ`<image>`
> في الشبكةِ نفسِها، و`spot` لم يُمَسّ. اختبارُ النقرِ ذو الطرفَين ناجحٌ والإطارُ `qf-l`.
...
## بند ١١ — `g1d1-2-6` · السؤال الإثرائي (تلوين: غصنُ نسبِ النبيِّ ﷺ) — **مسار n8n + vtracer**

> ✅ **أُنجِزَ ٢٠٢٦-٠٩-٠٢** بطلبِ المالك «استبدل الرسمة برسمة من n8n». ولأنّ النوعَ
> `color` تُقرَأُ إجابتُه من مساراتِ الرسمِ (لا يُستبدَلُ بصورةٍ نقطية)، سُلِكَ المسارُ
> الكاملُ: توليدٌ بألوانِ عزلٍ ثمّ تتبّعٌ ثمّ تحييد.

- **الدفعة:** `2026-09-02-family-tree-leaves` — عنصرٌ واحدٌ `family-tree-leaves`، برومبتٌ
  **مسطّحٌ** (بلا لمعةٍ ولا تدرّج — شرطُ التتبّع §٢) بثلاثِ بيضاواتٍ كبيرةٍ لا تتلامس:
  الأعلى `#7B2FF2` · اليمنى `#FF00FF` · اليسرى `#00FFFF`، وجذعٌ بنّيٌّ `#7A4C22`.
- **نتيجةُ البوّابة:** ✅ ثلاثُ مناطقَ · حدودٌ مغلقة · بلا تداخل · لونٌ فريدٌ لكلٍّ.
- **التتبّع:** `vtracer` (بايثون) `color_precision 4 · filter_speckle 16 · spline · path_precision 2`
  ← **١٨ مساراً / ٦٤ KB**؛ **كلُّ ورقةٍ مسارٌ واحد** (‏`#7A2CE7` · `#FB02F8` · `#01FCFD`)،
  الجذعُ مسارٌ واحد، والباقي ١٣ شظيّةَ حدٍّ داكنةٍ (خليطُ JPEG) وُحِّدَت كلُّها إلى `#111111`.
- **ما بعدَ التتبّع:** حُذِفَ مسارُ الخلفيةِ الأبيض؛ كلُّ ورقةٍ داخلَ `<g class="cpart" data-name id fill="#E8E4DC">`
  (المسارُ بلا `fill` فيرثُ تعبئةَ المجموعةِ التي يكتبُها التلوين)، والنصُّ فوقَها مركَّزاً على
  صندوقِ لونِها المقيسِ من الصورة؛ الجذعُ والحدودُ في مجموعةٍ عليا `pointer-events="none"`.
  `viewBox` **1456×720** (نسبة ٢٫٠٢ ≤ ٢٫٢). **٦٥ KB** inline، بلا `<style>`، التعبئةُ سماتٌ.
- **التحقّقُ الحيّ (١٢٨٠×٨٠٠، خطوطٌ حقيقية):** الإطارُ `qf-tall` فارغاً وممتلئاً؛ تلوينُ الأوراقِ
  الثلاثِ بألوانِها ← «🎨 أحسنت! لوّنت كل جزء باللون الصحيح»؛ صفرُ أخطاء.
- **المصدرُ النقطيّ** محفوظٌ محلياً خارجَ المستودع (§٦).

> **مراجعةٌ ٢: أوراقٌ لوزيةٌ مدبّبةٌ وجذعٌ أغنى (خيارُ المالك ١ — ٢٠٢٦-٠٩-٠٢).**
> الشكلُ الأوّلُ (بيضاواتٌ بسيطة) بدا صناعياً؛ أُعيدَ التوليدُ بدفعةِ
> `2026-09-02-family-tree-leaves-v2` بشكلِ ورقةٍ حقيقيٍّ (لوزيةٌ منحنيةٌ برأسٍ مدبّب)
> وجذعٍ متعرّجِ الحوافّ بلا تغييرِ الألوانِ ولا شرطِ التسطّح. التتبّعُ بالإعدادِ نفسِه
> ← **١٥ مساراً / ٥١ KB**، كلُّ ورقةٍ مسارٌ واحدٌ سليم؛ الجذعُ خرجَ أربعَ شظايا (تفاوتُ
> إضاءةِ JPEG) وُحِّدَت جميعُها إلى `#7A4C22`. تحقّقٌ حيٌّ مطابقٌ للأوّل: qf-tall،
> تلوينٌ صحيحٌ ← «أحسنت»، صفرُ أخطاء. **هذه النسخةُ المعتمَدةُ المرفوعة.**

---

## بند ١٢ — `g2d2-3-1` · السؤال الثاني (تحديد الأجزاء: علامة سجود التلاوة) — **توليد بجيميناي**

> ✅ **أُنجِزَ ٢٠٢٦-٠٩-٠٢ عبرَ مسارِ n8n — ثلاثُ محاولات.** المالكُ رفضَ المِحرابَ المقبَّبَ
> اليدويَّ الأصليَّ («لا يطابق ما هو في المصحف»)، ثمّ رفضَ مثمَّناً بُنيَ على هندسةِ رمزِ
> يونيكود ۩ المصيَّرِ فعلياً بخطِّ Noto Naskh Arabic (لم يكن مطابقاً أيضاً)، وأرسلَ أخيراً
> **صورةً بخطِّ يدِه** للشكلِ الصحيح: قبّةٌ مُدبَّبةٌ (كمِئذنة) بشكلٍ داخليٍّ يشبهُ حدودَها
> الخارجيةَ إلى حدٍّ كبير — لا سهماً ولا مثلثاً على عمود.
- **الدفعةُ الأولى** (`sajda-mark-icon`) رسمَت الداخلَ سهماً — رُفِضَت.
- **الدفعةُ الثانيةُ** (`sajda-mark-icon-v2`) صحَّحَت البرومبتَ صراحةً: «لا تجعلْه سهماً، بل
  نسخةً أصغرَ من الشكلِ الخارجيِّ نفسِه» ← **اعتمدها المالكُ حرفياً** («نعم، طابق»).
- `images/سجود-تلاوة.png` (‏٢٥٧×٣٦٠، خلفيةٌ مفرَّغة) استبدلَ الشكلَ اليدويَّ داخلَ صندوقِه
  نفسِه؛ `spot` نسبةٌ من الإطارِ لا من الأيقونةِ فلم يتغيَّر.
- تحقّقٌ حيّ (١٢٨٠×٨٠٠): الإطارُ `qf-l`، نقرُ علامةِ رقمِ الآيةِ يُرَدُّ ونقرُ الصورةِ الجديدةِ
  يُقبَل («أحسنت»)، صفرُ أخطاء.
