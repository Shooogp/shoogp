...
function loadPics() {
  ...
  return { has: w => !!win.qPic(w), size: Object.keys(win.QPICS).length };
}
...
console.log(`✓ رسومُ البطاقاتِ سليمة — ${PICS.size} مفتاحاً في السِّجِلّ، ولا مجموعةَ مختلطةً ولا كاشفة.`);
