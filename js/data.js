  ...
  index: {
    ...
    "g3-en": { book:"اللغة الإنجليزية — الصف الثالث", units:[
      ...
      { unit:"It's a happy day!", lessons:[
        { title:"It's a happy day! (Vocabulary)", file:"g3e-1-1", open:true },
        { title:"Atomic is colourful! (Story)", file:"g3e-1-2", open:true },
        { title:"Times of the day (Grammar)", file:"g3e-1-3", open:true },
        { title:"Skills", file:"g3e-1-4", open:true },
        { title:"Traditional breakfasts (Culture & Project)", file:"g3e-1-5", open:true },
        { title:"Saying the time", file:"g3e-1-6", open:true },
