/* ═══════════════════════════════════════════════════════════════
   نسخة احتياطية من البيانات — تُستخدم تلقائياً عند فتح index.html
   بالنقر المزدوج (وضع file://) حيث يمنع المتصفح قراءة ملفات JSON.
   ⚠️ يجب أن تبقى مطابقة لمحتوى data/books.json و data/index.json.
   إن عدّلت ملفات JSON، حدّث هذا الملف أيضاً (أو شغّل عبر الخادم المحلي).
   ═══════════════════════════════════════════════════════════════ */
window.DATA_FALLBACK = {
  ...
  terms: {
    "الأول": {
      "الأول": [
        { key:"g1-sci", band:["#4bb3ab","#33978f"], title:"العلوم", term:"الفصل الأول", color:"bk-teal", ic:"🔬", isNew:false, onSale:true, theme:"theme-sci1", cover:"images/cover-g1-sci.jpg" },
        { key:"g1-math", band:["#30b8d0","#2590a2"], title:"الرياضيات", term:"الفصل الأول", color:"bk-teal", ic:"📐", isNew:false, onSale:true, theme:"theme-math1", cover:"images/cover-g1-math.jpg" },
      ...
      "الثاني": [
        ...
        { key:"g2-math", band:["#f5a04a","#e07f2b"], title:"الرياضيات", term:"الفصل الأول", color:"bk-orange", ic:"📐", isNew:false, onSale:true, theme:"theme-math2", cover:"images/cover-g2-math.jpg" },
      ...
      "الثالث": [
        { key:"g3-sci", band:["#f26169","#cf3a44"], title:"العلوم", term:"الفصل الأول", color:"bk-red", ic:"🔬", isNew:false, onSale:true, theme:"theme-sci3", cover:"images/cover-g3-sci.jpg" },
        { key:"g3-math", band:["#f0596e","#cf3a52"], title:"الرياضيات", term:"الفصل الأول", color:"bk-red", ic:"📐", isNew:false, onSale:true, theme:"theme-math3", cover:"images/cover-g3-math.jpg" },
        ...
        { key:"g3-en", band:["#0089CE","#006EA5"], title:"اللغة الإنجليزية", term:"الفصل الأول", color:"bk-cyan", ic:"💬", isNew:true, onSale:false, devOnly:true, theme:"theme-en3", cover:"images/cover-g3-en.jpg" }
      ],
      "الرابع": [
        ...
        { key:"g4-math", band:["#8abc32","#719a29"], title:"الرياضيات", term:"الفصل الأول", color:"bk-orange", ic:"📐", isNew:false, onSale:true, theme:"theme-math", cover:"images/cover-g4-math.jpg" },
        ...
        { key:"g4-en", band:["#00A838","#00862D"], title:"اللغة الإنجليزية", term:"الفصل الأول", color:"bk-emerald", ic:"💬", isNew:true, onSale:false, devOnly:true, theme:"theme-en4", cover:"images/cover-g4-en.jpg" }
      ]
    },
    "الثاني": {
      "الأول": [],
  ...
  index: {
    ...
    "g2-math": { book:"الرياضيات — الصف الثاني", units:[
      { unit:"١أ: العدد وحل المشكلات", lessons:[
        ...
        { title:"العد بالاثنينات، الخمسات والعشرات (٢-١)", file:"g2m-2-1", chapter:2, chapterTitle:"العد بالاثنينات، الخمسات والعشرات", open:true },
        { title:"الأزواج العددية لـ١٠٠ (٣-١)", file:"g2m-3-1", chapter:3, chapterTitle:"خط الأعداد حتى ١٠٠", open:true },
        { title:"جمع وطرح الأزواج العددية لـ١٠٠ (٣-٢)", file:"g2m-3-2", chapter:3, chapterTitle:"خط الأعداد حتى ١٠٠", open:true },
        { title:"استخدام خط الأعداد (٤-١)", file:"g2m-4-1", chapter:4, chapterTitle:"استخدام خط الأعداد", open:true },
        { title:"تقريب الأعداد باستخدام خط الأعداد (٤-٢)", file:"g2m-4-2", chapter:4, chapterTitle:"استخدام خط الأعداد", open:true },
        { title:"الأزواج العددية لـ٢٠ (٥-١)", file:"g2m-5-1", chapter:5, chapterTitle:"اللعب بـ٢٠", open:true },
        { title:"الأزواج العددية بين ١٠ و٢٠ (٥-٢)", file:"g2m-5-2", chapter:5, chapterTitle:"اللعب بـ٢٠", open:true },
        { title:"الجمع باستخدام الأزواج العددية (٦-١)", file:"g2m-6-1", chapter:6, chapterTitle:"الجمع والطرح (١)", open:true },
        { title:"التحقق من الحل (٦-٢)", file:"g2m-6-2", chapter:6, chapterTitle:"الجمع والطرح (١)", open:true },
        { title:"المتساوي والمتكافئ (٦-٣)", file:"g2m-6-3", chapter:6, chapterTitle:"الجمع والطرح (١)", open:true },
      ...
      { unit:"١ج: القياس وحل المشكلات", lessons:[
        { title:"صناعة علبة (٩-١)", file:"g2m-9-1", chapter:9, chapterTitle:"قياس الطول", open:true },
        { title:"قياس المسافة (٩-٢)", file:"g2m-9-2", chapter:9, chapterTitle:"قياس الطول", open:true },
        { title:"صناعة أجسام متحركة (٩-٣)", file:"g2m-9-3", chapter:9, chapterTitle:"قياس الطول", open:true },
        { title:"قياس الوقت (١٠-١)", file:"g2m-10-1", chapter:10, chapterTitle:"قياس الوقت والمسافة", open:true },
        { title:"قياس المسافة (١٠-٢)", file:"g2m-10-2", chapter:10, chapterTitle:"قياس الوقت والمسافة", open:true },
        { title:"قياس الارتفاع (١٠-٣)", file:"g2m-10-3", chapter:10, chapterTitle:"قياس الوقت والمسافة", open:true },
        { title:"قياس المكونات (١١-١)", file:"g2m-11-1", chapter:11, chapterTitle:"قياس الكتلة والوقت والإنفاق", open:true },
        { title:"وقت الطهي (١١-٢)", file:"g2m-11-2", chapter:11, chapterTitle:"قياس الكتلة والوقت والإنفاق", open:true },
        { title:"البسكويت الثمين (١١-٣)", file:"g2m-11-3", chapter:11, chapterTitle:"قياس الكتلة والوقت والإنفاق", open:true }
      ]},
      { unit:"٢أ: العدد وحل المشكلات", lessons:[
        ...
        { title:"مقارنة وترتيب الأعداد (١٢-٢)", file:"g2m-12-2", chapter:12, chapterTitle:"العشرات والآحاد حتى ١٠٠", open:true },
        { title:"التقدير (١٣-١)", file:"g2m-13-1", chapter:13, chapterTitle:"التقدير", open:true },
        { title:"الأزواج العددية لـ٢٠ (١٤-١)", file:"g2m-14-1", chapter:14, chapterTitle:"أنماط الأعداد", open:true },
        { title:"الضعف (١٤-٢)", file:"g2m-14-2", chapter:14, chapterTitle:"أنماط الأعداد", open:true },
        { title:"تصنيف الأعداد (١٤-٣)", file:"g2m-14-3", chapter:14, chapterTitle:"أنماط الأعداد", open:true },
        { title:"الأعداد المكونة من رقم أو رقمين (١٥-١)", file:"g2m-15-1", chapter:15, chapterTitle:"الجمع والطرح (٢)", open:true },
        { title:"الأعداد المكونة من رقمين (١٥-٢)", file:"g2m-15-2", chapter:15, chapterTitle:"الجمع والطرح (٢)", open:true },
        { title:"العثور على الفرق (١٦-١)", file:"g2m-16-1", chapter:16, chapterTitle:"العثور على الفروقات البسيطة", open:true },
        { title:"المصفوفات (١٧-١)", file:"g2m-17-1", chapter:17, chapterTitle:"التجميع والمشاركة", open:true },
        { title:"العد بالاثنينات والخمسات والعشرات (١٧-٢)", file:"g2m-17-2", chapter:17, chapterTitle:"التجميع والمشاركة", open:true },
        { title:"القسمة (١٧-٣)", file:"g2m-17-3", chapter:17, chapterTitle:"التجميع والمشاركة", open:true }
      ]}
    ]},
    "g4-sci": { book:"العلوم — الصف الرابع", units:[
      { unit:"الإنسان والحيوان", lessons:[
        { title:"الهياكل العظمية", file:"g4s-1-1", open:true },
        { title:"الهيكل العظمي للإنسان", file:"g4s-1-2", open:true },
    ...
    "g3-sci": { book:"العلوم — الصف الثالث", units:[
      { unit:"الاعتناء بالنباتات", lessons:[
        ...
        { title:"تحقّق من تقدّمك", file:"g3s-1-5", open:true }
      ]},
      { unit:"الاعتناء بأنفسنا", lessons:[
        ...
        { title:"تحقّق من تقدّمك", file:"g3s-2-5", open:true }
      ]},
      { unit:"الكائنات الحية", lessons:[
        ...
        { title:"تحقّق من تقدّمك", file:"g3s-3-6", open:true }
      ]}
    ]},
    "g4-math": { book:"الرياضيات — الصف الرابع", units:[
      ...
      { unit:"٢أ: العدد وحلّ المشكلات", lessons:[
        ...
        { title:"١٠-١ الجمع والطرح لأعداد قريبة من مضاعفات العدد ١٠", file:"g4m-10-1", open:true },
        { title:"١٠-٢ اختيار الاستراتيجية الأنسب للطرح", file:"g4m-10-2", open:true },
        { title:"١١-١ تدريبات ضرب إضافية", file:"g4m-11-1", open:true },
        { title:"١١-٢ قسمة عدد من رقمين على عدد من رقم واحد", file:"g4m-11-2", open:true }
      ]}
    ]},
    ...
    "g4-dini-2": { book:"ديني حياتي (الجزء الثاني) — الصف الرابع", units:[
      ...
      { unit:"الوحدة الثالثة", lessons:[
        ...
        { title:"الدرس الرابع: شروط صحّة الصلاة", file:"g4d2-3-4", open:true },
        { title:"الدرس الخامس: المُقاطعة", file:"g4d2-3-5", open:true },
        { title:"الدرس السادس: المُساواة", file:"g4d2-3-6", open:true }
      ]},
      /* ⚠️ الوحدةُ الرابعةُ كانت **مفقودةً بكاملِها** من الفهرسَين معاً
         (‏`data/index.json` و هذا الملفّ) — وهي في دليلِ المعلّمِ ص ١٤١ وكتابِ
         التلميذِ ج٢ ص ٥٥. **وخمسةُ دروسٍ لا ستّةٌ** بخلافِ بقيّةِ الوحدات. */
    ...
    "g4-it": { book:"عالمي الرقمي — الصف الرابع", units:[
      ...
      { unit:"لنعرض أفكارنا", lessons:[
        ...
        { title:"التعامل مع الصور", file:"g4i-2-2", open:true },
        { title:"التأثيرات الانتقالية والحركية", file:"g4i-2-3", open:true },
    ...
    "g1-math": { book:"الرياضيات — الصف الأول", units:[
      ...
      { unit:"٢أ: العدد وحل المشكلات", lessons:[
        { title:"الأعداد الزوجيّة (١١-١)", file:"g1m-11-1", chapter:11, chapterTitle:"الأعداد الفردية والزوجية", open:true },
        { title:"الأعداد الفرديّة (١١-٢)", file:"g1m-11-2", chapter:11, chapterTitle:"الأعداد الفردية والزوجية", open:true },
        { title:"ترتيب الأعداد (١٢-١)", file:"g1m-12-1", chapter:12, chapterTitle:"ترتيب الأعداد (١)", open:true },
        { title:"بين (١٢-٢)", file:"g1m-12-2", chapter:12, chapterTitle:"ترتيب الأعداد (١)", open:true },
        { title:"المزيد من أزواج الأعداد لـ١٠ (١٣-١)", file:"g1m-13-1", chapter:13, chapterTitle:"الجمع والطرح: الإضافة والحذف", open:true },
        { title:"الجمع على شكل ضم (١٣-٢)", file:"g1m-13-2", chapter:13, chapterTitle:"الجمع والطرح: الإضافة والحذف", open:true },
        { title:"الطرح على شكل الأخذ من (١٣-٣)", file:"g1m-13-3", chapter:13, chapterTitle:"الجمع والطرح: الإضافة والحذف", open:true },
        { title:"خط الأعداد (١) إيجاد الفرق (١٣-٤)", file:"g1m-13-4", chapter:13, chapterTitle:"الجمع والطرح: الإضافة والحذف", open:true },
        { title:"خط الأعداد (٢) إضافة وطرح اثنين (١٣-٥)", file:"g1m-13-5", chapter:13, chapterTitle:"الجمع والطرح: الإضافة والحذف", open:true },
        { title:"ترتيب الأعداد (١٤-١)", file:"g1m-14-1", chapter:14, chapterTitle:"ترتيب الأعداد (٢)", open:true },
        { title:"المجموعات (١٤-٢)", file:"g1m-14-2", chapter:14, chapterTitle:"ترتيب الأعداد (٢)", open:true }
      ]}
    ]},
    ...
    "g1-arabic-2": { book:"أحب لغتي (الجزء الثاني) — الصف الأول", units:[
      ...
      { unit:"المحور الرابع: هَذا غِذائي", lessons:[
        { title:"الدرس الأول: ء", file:"g1a2-4-1", open:true },
        { title:"الدرس الثاني: ج", file:"g1a2-4-2", open:true },
        { title:"الدرس الثالث: و", file:"g1a2-4-3", open:true },
    ...
    "g3-arabic-1": { book:"أحب لغتي (الجزء الأول) — الصف الثالث", units:[
      ...
      { unit:"المحور الأول: الحياة من حولي", lessons:[
        ...
        { title:"مستند بصري: قراءة إعلان إرشاديّ", file:"g3a1-1-2", open:true },
        { title:"الدرس الأول: التَّيمينة", file:"g3a1-1-3", open:true },
    ...
    "g1-dini-1": { book:"ديني حياتي (الجزء الأول) — الصف الأول", units:[
      ...
      { unit:"الوحدة الأولى", lessons:[
        ...
        { title:"الدرس الثاني: أنا مُسلمٌ نظيف", file:"g1d1-1-2", open:true },
    ...
    "g2-dini-1": { book:"ديني حياتي (الجزء الأول) — الصف الثاني", units:[
      ...
      { unit:"الوحدة الثانية", lessons:[
        ...
        { title:"الدرس السادس: الصَّفح الجميل", file:"g2d1-2-6", open:true }
      ]}
    ]},
    "g2-dini-2": { book:"ديني حياتي (الجزء الثاني) — الصف الثاني", units:[
      ...
      { unit:"الوحدة الرابعة", lessons:[
        ...
        { title:"الدرس الثاني: أُطيع الله تعالى", file:"g2d2-4-2", open:true },
        { title:"الدرس الثالث: أتعلَّم العِلم", file:"g2d2-4-3", open:true },
        { title:"الدرس الرابع: التشهُّد (التحيّات)", file:"g2d2-4-4", open:true },
        { title:"الدرس الخامس: محمّد ﷺ النبيُّ الأمين", file:"g2d2-4-5", open:true },
    ...
    "g2-it": { book:"عالمي الرقمي — الصف الثاني", units:[
      ...
      { unit:"هيّا نُصَمِّمُ", lessons:[
        { title:"مُقَدِّمَةٌ إلى الرَّسمِ ثُلاثيِّ الأَبعادِ", file:"g2i-2-1", open:true },
        { title:"التَّعامُلُ مَعَ شَكلٍ ثُلاثيِّ الأَبعادِ", file:"g2i-2-2", open:true },
        { title:"لِنَتَدَرَّبْ على التَّعامُلِ مَعَ كائنٍ ثُلاثيِّ الأَبعادِ", file:"g2i-2-3", open:true },
        { title:"إِنشاءُ نَموذَجٍ ثُلاثيِّ الأَبعادِ", file:"g2i-2-4", open:true },
        { title:"لِنَتَدَرَّبْ على النَّماذِجِ ثُلاثيَّةِ الأَبعادِ", file:"g2i-2-5", open:true },
    ...
    "g3-dini-1": { book:"ديني حياتي (الجزء الأول) — الصف الثالث", units:[
      ...
      { unit:"الوحدة الأولى", lessons:[
        ...
        { title:"الدرس الثالث: آمنتُ بالله (١)", file:"g3d1-1-3", open:true },
        { title:"الدرس الرابع: أُحافظ على صلاتي", file:"g3d1-1-4", open:true },
        { title:"الدرس الخامس: في غار حِراء", file:"g3d1-1-5", open:true },
    ...
    "g3-it": { book:"عالمي الرقمي — الصف الثالث", units:[
      ...
      { unit:"هيّا نكتب", lessons:[
        ...
        { title:"إدراج وتنسيق صورة", file:"g3i-2-3", open:true },
        { title:"لنتدرّب على التعامل مع النص وتنسيق الصور", file:"g3i-2-4", open:true },
        { title:"إنشاء القوائم", file:"g3i-2-5", open:true },
        { title:"لنتدرّب على التعامل مع القوائم", file:"g3i-2-6", open:true },
        { title:"المشروع", file:"g3i-2-7", open:true }
      ]},
      { unit:"عالمي المتصل", lessons:[
        { title:"الأمان عبر الإنترنت", file:"g3i-3-1", open:true },
        { title:"البحث عن المعلومات", file:"g3i-3-2", open:true },
    ...
    "g3-en": { book:"اللغة الإنجليزية — الصف الثالث", units:[
      { unit:"Welcome: Back to school", lessons:[
        { title:"Lesson 1 · Classroom language", file:"g3e-0-1", open:true },
        { title:"Lesson 2 · Alphabet & Grammar: Asking for and spelling names", file:"g3e-0-2", open:true },
        { title:"Lesson 3 · Numbers 11–20", file:"g3e-0-3", open:true }
      ]},
      { unit:"It's a happy day!", lessons:[
        { title:"Lesson 1 · Vocabulary and Grammar: It's a happy day!", file:"g3e-1-1", open:true },
        { title:"Lesson 2 · Story: Atomic is colourful!", file:"g3e-1-2", open:true },
        { title:"Lesson 3 · Vocabulary and Grammar: Times of the day", file:"g3e-1-3", open:true },
        { title:"Lesson 4 · Skills", file:"g3e-1-4", open:true },
        { title:"Lesson 5 · Culture & Project: Traditional breakfasts", file:"g3e-1-5", open:true },
        { title:"Lesson 6 · English in action: Saying the time", file:"g3e-1-6", open:true },
        { title:"Lesson 7 · Phonics: wh, ph", file:"g3e-1-7", open:true },
        { title:"Lesson 8 · Review", file:"g3e-1-8", open:true },
        { title:"Lesson 9 · Get ready for… (Pre A1 Starters)", file:"g3e-1-9", open:true },
        { title:"Lesson 10 · Fun corner", file:"g3e-1-10", open:true },
        { title:"Graded readers: Robot School · Elephant's Day", file:"g3e-1-gr", open:true }
      ]},
      { unit:"Let's dress up!", lessons:[
        { title:"Lesson 1 · Vocabulary and Grammar: Let's dress up!", file:"g3e-2-1", open:true },
        { title:"Lesson 2 · Story: The school show", file:"g3e-2-2", open:true },
        { title:"Lesson 3 · Vocabulary and Grammar: Whose is it?", file:"g3e-2-3", open:true },
        { title:"Lesson 4 · Skills", file:"g3e-2-4", open:true },
        { title:"Lesson 5 · Culture & Project: Special days in Oman", file:"g3e-2-5", open:true },
        { title:"Lesson 6 · English in action: Asking the price", file:"g3e-2-6", open:true },
        { title:"Lesson 7 · Phonics: ear, ure", file:"g3e-2-7", open:true },
        { title:"Lesson 8 · Review", file:"g3e-2-8", open:true },
        { title:"Lesson 9 · Get ready for… (Pre A1 Starters)", file:"g3e-2-9", open:true },
        { title:"Lesson 10 · Fun corner", file:"g3e-2-10", open:true },
        { title:"Graded readers: The Clothes Game · Dad's Tracksuit", file:"g3e-2-gr", open:true }
      ]},
      { unit:"Atomic's Learning Club 1", lessons:[
        { title:"Lesson 1 · Language booster 1", file:"g3e-lc1-1", open:true },
        { title:"Lesson 2 · Maths: How do we measure things?", file:"g3e-lc1-2", open:true }
      ]},
      { unit:"Hobbies", lessons:[
        { title:"Lesson 1 · Vocabulary and Grammar: Hobbies", file:"g3e-3-1", open:true },
        { title:"Lesson 2 · Story: Where's Fatma?", file:"g3e-3-2", open:true },
        { title:"Lesson 3 · Vocabulary and Grammar: Days of the week", file:"g3e-3-3", open:true },
        { title:"Lesson 4 · Skills", file:"g3e-3-4", open:true },
        { title:"Lesson 5 · Culture & Project: Traditional sports in Oman", file:"g3e-3-5", open:true },
        { title:"Lesson 6 · English in action: Saying how often you do things", file:"g3e-3-6", open:true },
        { title:"Lesson 7 · Phonics: i_e, a_e, o_e, u_e", file:"g3e-3-7", open:true },
        { title:"Lesson 8 · Review", file:"g3e-3-8", open:true },
        { title:"Lesson 9 · Get ready for… (Pre A1 Starters)", file:"g3e-3-9", open:true },
        { title:"Lesson 10 · Fun corner", file:"g3e-3-10", open:true },
        { title:"Graded readers: Fun at the Park · The Camel Race", file:"g3e-3-gr", open:true }
      ]},
      { unit:"I want to be a doctor!", lessons:[
        { title:"Lesson 1 · Vocabulary and Grammar: I want to be a doctor!", file:"g3e-4-1", open:true },
        { title:"Lesson 2 · Story: The job fair", file:"g3e-4-2", open:true },
        { title:"Lesson 3 · Vocabulary and Grammar: How do you go to work?", file:"g3e-4-3", open:true },
        { title:"Lesson 4 · Skills", file:"g3e-4-4", open:true },
        { title:"Lesson 5 · Culture & Project: The yellow school bus", file:"g3e-4-5", open:true },
        { title:"Lesson 6 · English in action: Talking on the phone", file:"g3e-4-6", open:true },
        { title:"Lesson 7 · Phonics: ea, ea", file:"g3e-4-7", open:true },
        { title:"Lesson 8 · Review", file:"g3e-4-8", open:true },
        { title:"Lesson 9 · Get ready for… (Pre A1 Starters)", file:"g3e-4-9", open:true },
        { title:"Lesson 10 · Fun corner", file:"g3e-4-10", open:true },
        { title:"Graded readers: It's Jobs Day · A Boat to the Beach", file:"g3e-4-gr", open:true }
      ]},
      { unit:"Atomic's Learning Club 2", lessons:[
        { title:"Lesson 1 · Language booster 2", file:"g3e-lc2-1", open:true },
        { title:"Lesson 2 · Social Studies: Important months", file:"g3e-lc2-2", open:true }
      ]}
    ]},
    "g4-en": { book:"اللغة الإنجليزية — الصف الرابع", units:[
      { unit:"Welcome: New neighbours", lessons:[
        { title:"Lesson 1 · Countries and nationalities & Hobbies", file:"g4e-0-1", open:true },
        { title:"Lesson 2 · Numbers 50–100", file:"g4e-0-2", open:true }
      ]},
      { unit:"New school", lessons:[
        { title:"Lesson 1 · Vocabulary: School subjects", file:"g4e-1-1", open:true },
        { title:"Lesson 2 · Story: First day at a new school!", file:"g4e-1-2", open:true },
        { title:"Lesson 3 · Grammar: Present simple with days and times", file:"g4e-1-3", open:true },
        { title:"Lesson 4 · Vocabulary and Grammar: Adverbs of frequency", file:"g4e-1-4", open:true },
        { title:"Lesson 5 · Culture & Project: Unusual schools around the world", file:"g4e-1-5", open:true },
        { title:"Lesson 6 · English in action: Making arrangements", file:"g4e-1-6", open:true },
        { title:"Lesson 7 · Skills (Reading): Maryam's Diary", file:"g4e-1-7", open:true },
        { title:"Lesson 8 · Skills (Listening, Speaking & Writing)", file:"g4e-1-8", open:true },
        { title:"Lesson 9 · Phonics: y (revise i_e, igh, ie)", file:"g4e-1-9", open:true },
        { title:"Lesson 10 · Review", file:"g4e-1-10", open:true },
        { title:"Lesson 11 · Get ready for… (A1 Movers)", file:"g4e-1-11", open:true },
        { title:"Graded readers: Welcome to Our School · Hippo's Kite", file:"g4e-1-gr", open:true }
      ]},
      { unit:"Picnic time!", lessons:[
        { title:"Lesson 1 · Vocabulary: Food and drinks", file:"g4e-2-1", open:true },
        { title:"Lesson 2 · Story: The Secret Shed", file:"g4e-2-2", open:true },
        { title:"Lesson 3 · Grammar: There is / There are", file:"g4e-2-3", open:true },
        { title:"Lesson 4 · Vocabulary and Grammar: Food and drink containers", file:"g4e-2-4", open:true },
        { title:"Lesson 5 · Culture & Project: Food around the world", file:"g4e-2-5", open:true },
        { title:"Lesson 6 · English in action: Shopping for food", file:"g4e-2-6", open:true },
        { title:"Lesson 7 · Skills (Reading): Let's cook! — a recipe", file:"g4e-2-7", open:true },
        { title:"Lesson 8 · Skills (Listening, Speaking & Writing)", file:"g4e-2-8", open:true },
        { title:"Lesson 9 · Phonics: ow (revise oa, o_e)", file:"g4e-2-9", open:true },
        { title:"Lesson 10 · Review", file:"g4e-2-10", open:true },
        { title:"Lesson 11 · Get ready for… (A1 Movers)", file:"g4e-2-11", open:true },
        { title:"Graded readers: The New Shop · A Bowl of Soup", file:"g4e-2-gr", open:true }
      ]},
      { unit:"Bo's Learning Club 1", lessons:[
        { title:"Lesson 1 · Maths: Sizes and shapes", file:"g4e-lc1-1", open:true },
        { title:"Lesson 2 · Language booster 1", file:"g4e-lc1-2", open:true }
      ]},
      { unit:"Along the wadi", lessons:[
        { title:"Lesson 1 · Vocabulary: Landscapes", file:"g4e-3-1", open:true },
        { title:"Lesson 2 · Story: The Great Clean-up", file:"g4e-3-2", open:true },
        { title:"Lesson 3 · Grammar: Comparatives and superlatives", file:"g4e-3-3", open:true },
        { title:"Lesson 4 · Vocabulary and Grammar: Adjectives", file:"g4e-3-4", open:true },
        { title:"Lesson 5 · Culture & Project: Nature reserves in Oman", file:"g4e-3-5", open:true },
        { title:"Lesson 6 · English in action: Asking the way", file:"g4e-3-6", open:true },
        { title:"Lesson 7 · Skills (Reading): Wadi rescue! — a story", file:"g4e-3-7", open:true },
        { title:"Lesson 8 · Skills (Listening, Speaking & Writing)", file:"g4e-3-8", open:true },
        { title:"Lesson 9 · Phonics: eigh, ei", file:"g4e-3-9", open:true },
        { title:"Lesson 10 · Review", file:"g4e-3-10", open:true },
        { title:"Lesson 11 · Get ready for… (A1 Movers)", file:"g4e-3-11", open:true },
        { title:"Graded readers: The Boat Race · The Baby Bird", file:"g4e-3-gr", open:true }
      ]},
      { unit:"All about jobs", lessons:[
        { title:"Lesson 1 · Vocabulary: Jobs", file:"g4e-4-1", open:true },
        { title:"Lesson 2 · Story: The burglar", file:"g4e-4-2", open:true },
        { title:"Lesson 3 · Grammar: Present continuous", file:"g4e-4-3", open:true },
        { title:"Lesson 4 · Vocabulary and Grammar: Rules & must/mustn't", file:"g4e-4-4", open:true },
        { title:"Lesson 5 · Culture & Project: Some unusual jobs", file:"g4e-4-5", open:true },
        { title:"Lesson 6 · English in action: Calling the emergency services", file:"g4e-4-6", open:true },
        { title:"Lesson 7 · Skills (Reading): I love my job! — a careers website", file:"g4e-4-7", open:true },
        { title:"Lesson 8 · Skills (Listening, Speaking & Writing)", file:"g4e-4-8", open:true },
        { title:"Lesson 9 · Phonics: ew (revise oo, ue)", file:"g4e-4-9", open:true },
        { title:"Lesson 10 · Review", file:"g4e-4-10", open:true },
        { title:"Lesson 11 · Get ready for… (A1 Movers)", file:"g4e-4-11", open:true },
      ...
      { unit:"Bo's Learning Club 2", lessons:[
        { title:"Lesson 1 · Science: Health", file:"g4e-lc2-1", open:true },
        { title:"Lesson 2 · Language booster 2", file:"g4e-lc2-2", open:true }
      ]}
    ]}
  }
};
