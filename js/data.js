  ...
  index: {
    ...
    "g3-en": { book:"اللغة الإنجليزية — الصف الثالث", units:[
      ...
      { unit:"Let's dress up!", lessons:[
        ...
        { title:"Asking the price", file:"g3e-2-6", open:true },
      ...
      { unit:"Hobbies", lessons:[
        ...
        { title:"Saying how often you do things", file:"g3e-3-6", open:true },
    ...
    "g4-en": { book:"اللغة الإنجليزية — الصف الرابع", units:[
      ...
      { unit:"New school", lessons:[
        ...
        { title:"First day at a new school (Story)", file:"g4e-1-2", open:false },
        { title:"Present simple with days and times (Grammar)", file:"g4e-1-3", open:false },
        { title:"Adverbs of frequency (Vocabulary & Grammar)", file:"g4e-1-4", open:false },
        { title:"Unusual schools around the world (Culture & Project)", file:"g4e-1-5", open:false },
        { title:"Making arrangements", file:"g4e-1-6", open:false },
        { title:"Reading: Maryam's Diary (Skills)", file:"g4e-1-7", open:false },
        { title:"Listening, Speaking & Writing (Skills)", file:"g4e-1-8", open:false },
        { title:"y, revise i_e/igh/ie (Phonics)", file:"g4e-1-9", open:false },
        { title:"Review", file:"g4e-1-10", open:false },
        { title:"Get ready for… (A1 Movers)", file:"g4e-1-11", open:false }
      ]},
