  ...
  index: {
    ...
    "g4-en": { book:"اللغة الإنجليزية — الصف الرابع", units:[
      ...
      { unit:"New school", lessons:[
        { title:"School subjects (Vocabulary)", file:"g4e-1-1", open:true },
        { title:"First day at a new school (Story)", file:"g4e-1-2", open:true },
        { title:"Present simple with days and times (Grammar)", file:"g4e-1-3", open:true },
        { title:"Adverbs of frequency (Vocabulary & Grammar)", file:"g4e-1-4", open:true },
        { title:"Unusual schools around the world (Culture & Project)", file:"g4e-1-5", open:true },
        { title:"Making arrangements", file:"g4e-1-6", open:true },
        { title:"Reading: Maryam's Diary (Skills)", file:"g4e-1-7", open:true },
