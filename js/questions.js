...
window.QUESTIONS = {
  ...
  "g4s-1-1": [
    ...
    // عدسة أشعة سينية فوق صورة طفل تكشف هيكله العظمي. الصورتان متطابقتا الأبعاد:
    // العلوية "طفل-أشعة.png" (الطفل) والسفلية "طفل-أشعة-خفي.png" (هيكله العظمي).
    // ⚠️ الصورتان لم تُرفعا بعد إلى مجلد images/ — تُرفعان بهذين الاسمين، ثم تُعاير
    //    إحداثيات النقاط الساخنة أدناه على الصورة الفعلية (القيم الحالية تقديرية).
    {
      type: "lens",
      objective: "4Bh1: يستنتج أنّ للإنسان وبعض الحيوانات هيكلاً عظميًّا داخل الجسم",
      level: "application",
      ...
      bg: "#fdf9ee",
      spots: [
        { label: "الجمجمة",       x: 50, y: 10, r: 9 },
        { label: "القفص الصدري",  x: 50, y: 30, r: 10 },
        { label: "العمود الفقري", x: 50, y: 45, r: 8 },
        { label: "عظام الذراعين", x: 27, y: 40, r: 9 },
        { label: "عظام الساقين",  x: 45, y: 75, r: 11 }
      ]
    }
