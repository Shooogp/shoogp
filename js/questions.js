...
window.QUESTIONS = {
  ...
  "g4s-1-1": [
    ...
    // عدسة أشعة سينية فوق صورة طفل تكشف هيكله العظمي. الصورتان متطابقتا الأبعاد (أفقيتان 3:2):
    // العلوية "طفل-أشعة.png" (الطفل بقميصه) والسفلية "طفل-أشعة-خفي.png" (طبقة الهيكل العظمي).
    // ⚠️ ملفا الصورتين لم يصلا إلى المستودع بعد — يُرفعان إلى images/ بهذين الاسمين.
    {
      type: "lens",
      objective: "4Bh1: يستنتج أنّ للإنسان وبعض الحيوانات هيكلاً عظميًّا داخل الجسم",
      level: "application",
      ...
      spots: [
        ...
        { label: "عظام الذراعين", x: 40.5, y: 55,   r: 8,   alt: { x: 59.5, y: 55 } },
        { label: "عظام الساقين",  x: 45.5, y: 72.5, r: 9,   alt: { x: 53,   y: 72.5 } }
      ]
    }
