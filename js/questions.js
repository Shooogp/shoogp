...
window.QUESTIONS = {
  ...
  // العلوم/الثالث — الوحدة الأولى: نقل الماء — درس تجريبي لنوع «الطبقات (القشّر)» الجديد (قيد الاختبار)
  // النبتة كاملة (طبقتان متطابقتا الأبعاد ١٠٢٤×١٥٣٦): الخارجية "ساق-طبقة-١.png" (الساق خضراء)،
  // والداخلية "ساق-طبقة-٢.png" (أنابيب النقل وقد سرى فيها الماء الأزرق صاعداً من الجذور).
  // القشر محصور في مستطيل الساق (rect) فتبقى الأوراق والجذور ظاهرة. سؤالٌ واحد فقط (الدرس غير مؤلَّف).
  "g3s-1-3": [

    {
      type: "peel",
      objective: "يستنتج أنّ الماء ينتقل من الجذور عبر أنابيب داخل الساق صاعداً إلى الأوراق",
      level: "reasoning",
      prompt: "قشّر الطبقة الخضراء الخارجية للساق لتكشف ما بداخله، وسمِّ كلّ طبقة.",
      bg: "#fdfbf5",
      rect: { x: 43, y: 30, w: 14, h: 38 },
      layers: [
        {
          image: "images/ساق-طبقة-١.png",
          label: "القشرة الخارجية للساق",
          question: "ما هذه الطبقة الخضراء التي تغلّف الساق من الخارج؟",
          options: ["القشرة الخارجية للساق", "أنابيب نقل الماء", "الجذور"],
          answer: 0
        },
        {
          image: "images/ساق-طبقة-٢.png",
          label: "أنابيب نقل الماء",
          question: "ظهرت أنابيب سرى فيها الماء الأزرق صاعداً من الجذور — ما هذه الطبقة؟",
          options: ["أنابيب نقل الماء", "القشرة الخارجية للساق", "الأوراق"],
          answer: 0
        }
      ]
    }
