...
window.QUESTIONS = {
  ...
  "g4s-1-4": [
    ...
    // 🎨 التلوين بالتعليمات — إثرائي: تلوين العضلة المنقبضة والمنبسطة (رسم SVG بلا ملامح وجه)
    {
      ...
      svg: `<svg viewBox="0 0 320 300" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" role="img" aria-label="ذراع مثنية تُظهر العضلة الأمامية والخلفية">
        <g stroke="#cbb78a" stroke-width="11" stroke-linecap="round" fill="none">
          <line x1="70" y1="151" x2="185" y2="155"/>
          <line x1="185" y1="155" x2="150" y2="60"/>
        </g>
        <circle cx="70" cy="151" r="13" fill="#b7a06e"/>
        <circle cx="185" cy="155" r="12" fill="#b7a06e"/>
        <rect x="132" y="38" width="34" height="26" rx="10" fill="#b7a06e"/>
        <g class="cpart" data-name="العضلة الأمامية (منقبضة)" id="part-biceps">
          <ellipse cx="120" cy="115" rx="44" ry="21"/>
        </g>
        <g class="cpart" data-name="العضلة الخلفية (منبسطة)" id="part-triceps">
          <ellipse cx="120" cy="184" rx="52" ry="12"/>
        </g>
      </svg>`
    }
