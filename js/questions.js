...
window.QUESTIONS = {
  ...
  // العلوم/الثاني — الوحدة الثانية: التربة — درس تجريبي لنوع «الطبقات (القشّر)».
  // مقطع رأسيّ للتربة بثلاث طبقات متطابقة الأبعاد (١٠٢٤×١٥٣٦) تُقشَّر من الأعلى إلى الأسفل:
  // "تربة-طبقة-١.png" (السطحية، تعلوها الأعشاب) ← "تربة-طبقة-٢.png" (الفرعية بالحصى) ←
  // "تربة-طبقة-٣.png" (الصخر الأمّ). القشر محصور في مستطيل عمود التربة (rect). سؤالٌ واحد فقط (الدرس غير مؤلَّف).
  "g2s-2-3": [

    {
      type: "peel",
      objective: "يتعرّف إلى أنّ التربة تتكوّن من طبقات مرتّبة من الأعلى إلى الأسفل: التربة السطحية ثم التربة الفرعية ثم الصخر الأمّ، ويميّز بينها",
      level: "reasoning",
      prompt: "قشّر طبقات التربة من الأعلى إلى الأسفل، وسمِّ كلّ طبقة تظهر.",
      bg: "#fbf6ec",
      rect: { x: 3, y: 40, w: 94, h: 24 },
      layers: [
        {
          image: "images/تربة-طبقة-١.png",
          label: "التربة السطحية",
          question: "ما هذه الطبقة العُليا الداكنة التي تعلوها الأعشاب وتعيش فيها الكائنات؟",
          options: ["التربة السطحية", "التربة الفرعية", "الصخر الأمّ"],
          answer: 0
        },
        {
          image: "images/تربة-طبقة-٢.png",
          label: "التربة الفرعية",
          question: "بعد قشر الطبقة العُليا ظهرت طبقة أفتح لوناً مليئة بالحصى — ما هذه الطبقة؟",
          options: ["التربة الفرعية", "التربة السطحية", "الصخر الأمّ"],
          answer: 0
        },
        {
          image: "images/تربة-طبقة-٣.png",
          label: "الصخر الأمّ",
          question: "في الأسفل ظهرت طبقة صخرية صلبة متشقّقة — ما هذه الطبقة؟",
          options: ["الصخر الأمّ", "التربة السطحية", "التربة الفرعية"],
          answer: 0
        }
      ]
    }
