...
function renderMoney(q, body, fb){
  ...
  /* صورُ الفئاتِ الحقيقيةُ (من تصويرِ المعلّمِ — قرارُ المالك ٢٠٢٦-٠٩-٠١): تُعرَضُ
     ...
     على النقودِ بصيغةِ النموذج. والفئةُ التي لا صورةَ لها بعدُ تبقى على الرسمِ العامّ. */
  const MN_PHOTOS={ 50:{img:'عملة-٥٠-بيسة.png',coin:1}, 100:{img:'ورقة-١٠٠-بيسة.png'}, 1000:{img:'ورقة-ريال-واحد.png'} };
  function pieceSvg(v){
