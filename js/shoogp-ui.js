...
/* ═══ توسيعُ نصفِ القطرِ مع تثبيتِ المركز — لماذا يخالفُ الشريطُ البطاقةَ هنا ═══
   على البطاقةِ باطنُ الدائرةِ كلُّه مرئيّ، فيكفي أن يمرَّ القوسُ بنقطةِ الزاوية.
   أمّا الشريطُ فيغطّيه إطارُ السؤالِ المعتمُ إلا **حاشيةً رفيعةً 26px** حولَه؛ قِيسَ
   ظهورُ القرصِ فعلاً: 22–26٪ للعليا و7–29٪ للسفلى (والأسوأُ في الأسئلةِ الكبيرة).
   والحاشيةُ المكشوفةُ تقعُ عندَ الزاويةِ بالضبط — حيثُ ألفا الدائرةِ **صفرٌ** لأنّ
   القوسَ يمرُّ بها. فلا رفعُ ألفا يُنقذُها: الصفرُ صفرٌ مهما ضُرِب.
   الحلّ: يُثبَّتُ المركزُ ويُوسَّعُ نصفُ القطرِ حتى تقعَ نقطةُ الزاويةِ عندَ **74٪** من
   نصفِ القطر (بدايةِ التلاشي) بدلَ 100٪، فتصيرُ الحاشيةُ كلُّها في المنطقةِ المصمتة:
        0.289 ÷ 0.74 = 0.390   ·   0.237 ÷ 0.74 = 0.320
   المركزانِ والشفافيتانِ كما هما؛ والقوسُ يقطعُ الحوافَّ أبعدَ قليلاً — ثمنٌ مقبولٌ
   مقابلَ أن تُرى هويةُ البطاقةِ على الشريطِ فعلاً. */
var BAND_C1_X=0.222, BAND_C1_Y=0.185, BAND_C1_R=0.390;   /* العليا اليسرى */
var BAND_C2_X=0.147, BAND_C2_Y=0.185, BAND_C2_R=0.320;   /* السفلى اليمنى */
