...
/* ═══ أنصافُ الأقطار — **حدٌّ أدنى هندسيٌّ لا يجوزُ النزولُ تحتَه** ═══
   ...
   القيمُ الحالية (بطلبِ المالك: تصغيرُهما مع بقاءِ العليا أكبرَ بالثُلث تقريباً):
        العليا 0.330W (فوقَ حدِّها 0.289 بـ0.041)  ·  السفلى 0.248W (فوقَ 0.236 بـ0.012)
        والنسبةُ بينهما 0.330 ÷ 0.248 = **1.33** أي الثُلثُ تماماً.
...
var BAND_C1_X=0.222, BAND_C1_Y=0.185, BAND_C1_R=0.330;   /* العليا اليسرى */
var BAND_C2_X=0.147, BAND_C2_Y=0.185, BAND_C2_R=0.248;   /* السفلى اليمنى */
