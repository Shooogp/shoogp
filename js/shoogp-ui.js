...
var SUBJECT_SKINS={ science:'skin-rocky', math:'skin-metal', arabic:'skin-capsule',
                    deeny:'skin-ivory', en:'skin-leather' };
...
var FRAME_FAMILIES={
  ...
  /* اللغة الإنجليزية — عائلةُ إطارٍ بهويّةِ «تجليدِ كتابٍ ذهبيٍّ» (قرار المالك ٢٠٢٦-٠٩-١٥،
     مطابقةٌ لورقةِ مواصفاتِ فريماتِ الأسئلةِ رقم ٢ في CLAUDE.md): قماشٌ/جلدٌ ذهبيٌّ بخياطةِ
     خيطٍ ذهبيّ، وريشةٌ وكتابٌ مفتوحٌ ومكعّباتُ حروفٍ A/B/C (الحرفُ مسموحٌ هنا لأنّه موضوعُ
     المادّةِ نفسِه) وكوكبٌ حلقيٌّ ونجومٌ وجواهر على الحافّتَين العلويةِ واليمنى فقط —
     اليسرى خاليةٌ تماماً. l وs **مولَّدانِ مستقلَّينِ بجيميناي** (سير «شوجب — مولّد
     رسومات الأسئلة»، l على لوحة 1024×1024 وs على 1536×1024 فخرجت 1264×848)، وm وtall
     **مُشتقّانِ من l محلياً بالخياطةِ المحسوبة** (seam carving، مكتبة `seam-carving`)
     بقناعِ حمايةٍ يشملُ العمودَ الأيمنَ كاملاً (الريشة/الكتاب/المكعّبات/الكوكب/الجواهر)
     والشريطَ العلويّ، فيتركّزُ الإدراجُ في الشريطِ الأيسرِ الخالي بلا لمسِ أيِّ زخرفة —
     ولِـtall أُضيفَ قناعٌ خاصٌّ يحمي شارةَ النجمةِ السفليةِ المركزية (كانت تتمطّطُ بيضويّاً
     بلا هذه الحماية). ثمّ فُرِّغ الأبيضُ (خارجَ الإطارِ وداخلَ النافذةِ معاً) إلى شفافيةٍ
     حقيقيةٍ **بالفيضانِ (BFS) من الحوافِّ الأربعِ ومن مركزِ النافذةِ معاً لا بالمسافةِ
     اللونيةِ البحتة** — المسافةُ اللونيةُ وحدَها كانت تُفرِّغُ اللمعاتِ البيضاءَ الصغيرةَ
     داخلَ الكوكبِ والنجمةِ والجواهرِ (مقيسٌ: ثقوبٌ زرقاءُ صغيرةٌ ظهرت داخلَها)، والفيضانُ
     من مصدرَينِ منفصلَين لا يبلغُ اللمعاتِ المعزولةَ فتبقى معتمة. النافذةُ **شفافةٌ
     (hasFill:false)** كالقمريّ الافتراضيّ — يظهرُ حقلُ النجومِ المشتركُ خلالَها.
...
var FAMILY_BY_SUBJECT={ math:'math', arabic:'arabic', deeny:'deeny', it:'it', en:'en' };
