...
var FRAME_FAMILIES={
  ...
  it:{ order:['s','m','l','tall'], flexBase:'l', sizes:{
    s:{img:'frame-it-s.png', ar:'1359 / 577', win:{top:'14.66%', left:'8.02%',  right:'9.35%',  bottom:'12.72%'}, hasFill:false},
    m:{img:'frame-it-m.png', ar:'1189 / 938', win:{top:'21.11%', left:'11.86%', right:'16.32%', bottom:'14.07%'}, hasFill:false},
    l:{img:'frame-it-l.png', ar:'958 / 982',  win:{top:'21.09%', left:'14.3%',  right:'19.83%', bottom:'14.01%'}, hasFill:false},
    tall:{img:'frame-it-tall.png', ar:'956 / 1417', win:{top:'15.74%', left:'14.23%', right:'19.77%', bottom:'10.73%'}, hasFill:false}
  }}
};
