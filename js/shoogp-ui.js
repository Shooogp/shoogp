...
var FRAME_FAMILIES={
  ...
  /* عالمي الرقمي — عائلةُ إطارٍ بهويّةِ «قمرٍ صناعيٍّ ودارات» (قرار المالك ٢٠٢٦-٠٩-١٣):
     ...
     ⚠️ **حافّةُ bottom صُحِّحت ٢٠٢٦-٠٩-١٣** — قياسي الأصليّ (صندوقُ إحاطةِ كلِّ
     بكسلٍ شفّاف) وقعَ في فخِّ الشارةِ النجميةِ المركزية: النافذةُ تمتدُّ حولها
     شفّافةً فيبلغُ الصندوقُ عمقاً أكبرَ من عمقِ الإطارِ الحقيقيّ، بينما قياسُ
     `measureFrameGeo` الحيُّ (الذي تعتمدُه .qfill) يمسحُ **العمودَ الأوسطَ** فيصطدمُ
     بجسمِ الشارةِ المعتمِ فيقفُ عندَه — فاختلفَ الرقمانِ في bottom وحدَه (١٤٪ مقابل
     ١٨٪) وظهرَت .qfill الخضراءُ (لكلّ الأسئلةِ، css/shoogp-ui.css) في فجوةٍ أسفلَ
     محتوى qwin. **والقيمُ أدناه الآن مأخوذةٌ من `measureFrameGeo` نفسِه** (لا من
     صندوقِ الإحاطةِ) فتتطابقُ الطبقتانِ تماماً. */
  it:{ order:['s','m','l','tall'], flexBase:'l', sizes:{
    s:{img:'frame-it-s.png', ar:'1359 / 577', win:{top:'14.73%', left:'8.09%',  right:'9.34%',  bottom:'18.03%'}, hasFill:false},
    m:{img:'frame-it-m.png', ar:'1189 / 938', win:{top:'21%',    left:'11.94%', right:'16.23%', bottom:'17.91%'}, hasFill:false},
    l:{img:'frame-it-l.png', ar:'958 / 982',  win:{top:'21.08%', left:'14.41%', right:'19.73%', bottom:'18.02%'}, hasFill:false},
    tall:{img:'frame-it-tall.png', ar:'956 / 1417', win:{top:'15.74%', left:'14.23%', right:'19.67%', bottom:'13.62%'}, hasFill:false}
  }}
};
