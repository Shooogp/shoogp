/* ═══════════════════════════════════════════════════════════════════
   ...
   **هذا الملفُّ هو موطنُ قاعدةِ القفلِ كاملةً** — لا تُكرَّرْ في مكانٍ آخر.
   ...
   • **وعددُ المجانيِّ يختلفُ بالمادّة** (قرارُ المالك ٢٠٢٦-٠٩-٠٥ — `freeUnits` أدناه):
     ...
     | **اللغة الإنجليزية** (`g*-en`) | **الأولى والثانية** | ما بعدَهما |
...
(function () {
  ...
  function freeUnits(bookKey, unitCount) {
    ...
    /* الإنجليزية: وحدتانِ (قرارُ المالك ٢٠٢٦-٠٩-١٩). الأولى في كلِّ صفٍّ وحدةُ Welcome
       القصيرة (١–٣ دروس)، فوحدةٌ واحدةٌ لا تُري المعلّمةَ درساً حقيقياً من الكتاب؛ والشاشةُ
       تُرقّمُها «Unit 1» فالمجانيُّ ما تراه «Unit 1» و«Unit 2». */
    if (/^g\d+-en$/.test(k)) return 2;
    ...
    box.innerHTML =
      ...
      '<div class="lockbox" role="dialog" aria-modal="true" aria-labelledby="lockTitle">' +
        ...
        '<div class="lockbuyrow">' +
          ...
          '</a>' +
        '</div>' +
        /* رابطُ دليلِ الشراء — تحتَ الطريقَين لا فوقَهما: من عرفَتِ الطريقَ تمضي،
           ومن ترددَتْ تجدُ الشرحَ حيثُ ترددَتْ بالضبط. صفحةٌ منفصلةٌ في تبويبٍ
           جديدٍ حتى لا تُغلَقَ نافذةُ الرمزِ ويضيعَ ما كُتِبَ في الخانة.
           و`inert` عندَ إيقافِ الشراءِ يُخملُه مع بقيّةِ الكتلةِ تلقائياً. */
        '<a class="lockguide" href="guide.html" target="_blank" rel="noopener">' +
          'كيف أشتري؟ الدليل خطوة بخطوة' +
        '</a>' +
      '</div>' +
